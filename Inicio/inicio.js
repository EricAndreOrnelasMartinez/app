...
.then(data => {
    ...
    for(let i in data){
        ...
        <a href="../PHP/deletec.php?id=${data[i].ID_C}"><button class="js" type="button">Eliminar</button></a>
        <a href="editar/?id=${data[i].ID_C}"><button class="js" type="button">Editar</button></a>
        </div>`
    }
